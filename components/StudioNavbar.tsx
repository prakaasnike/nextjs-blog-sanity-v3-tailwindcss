        ...
        <div>
            <>
                <div className="flex items-center justify-between p-2">
                    <Link className="text-[#ffffffea] flex items-center  p-2 rounded-md bg-gray-50 bg-opacity-10 hover:shadow-md hover:scale-105 transition-all duration-100" href="/">
                    ...
                    <div className="hidden md:flex p-2 rounded-lg justify-center border-2 border-[#ffffff25]">
                        ...
                        <Link
                            className="text-[#ffffff] font-bold ml-2"
                            href=""
                        >
                            prakashnayak.com.np
                        </Link>
